...
export class HlmNavigationMenuContent {
  readonly navOffset = input<number, NumberInput>(1.5, {transform: numberAttribute});
  ...
  constructor() {
    classes(() => [
      ...
      'bg-popover text-popover-foreground ring-foreground/10 block rounded-lg shadow ring-1 transition-all ease-[cubic-bezier(0.22,1,0.36,1)] outline-none data-ending-style:scale-90 data-ending-style:opacity-0 data-ending-style:duration-150 data-starting-style:scale-90 data-starting-style:opacity-0',
    ]);
  }
}
